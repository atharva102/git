...
def assistant():
    ...
    try:
        ...
        if "Hello" in command:
            ...
            print("My name is Anna a k a yout virtual assistant master")
            engine_talk("My name is Anna a k a yout virtual assistant master")
...
print('\n')
print("hello, I am Anna, How can i help you?")
engine_talk ("hello i am Anna how can i help you?")
